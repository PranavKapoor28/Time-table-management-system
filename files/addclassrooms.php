    ...
    <div class="modal-content">
        ...
        <div class="modal-body" id="EnterClassroom">
            ...
            <div style="display:none" id="addClassroomForm">
                <form action="addclassroomFormValidation.php" method="POST" name="form" onsubmit="return validateForm()">
...
<script>
  ...
  var name = document.forms["form"]["CN"].value;
  if (name == "") {
...
<div align="center">
    ...
    <table id=classroomstable>
        <caption style="color:#fff"><strong>ADDED CLASSROOMS</strong></caption>
        <tr>
