    ...
    <div class="modal-content">
        ...
        <div class="modal-body" id="EnterSubject">
            ...
            <div style="display:none" id="addSubjectForm">
                <form action="addsubjectFormValidation.php" method="POST" name="form" onsubmit="return validateForm()">
...
<script>
  ...
  var name = document.forms["form"]["subjectname"].value;
  var code = document.forms["form"]["subjectcode"].value;
  var type = document.forms["form"]["subjecttype"].value;
  var sem = document.forms["form"]["subjectsemester"].value;
  var dep = document.forms["form"]["subjectdepartment"].value;
  if (name == "") {
  ...
  if (type == "") {
    alert("Subject type must be filled out");
  }
  if (sem == "") {
...
<div>
    ...
    <table id=subjectstable style="margin-left: 90px">
        <caption  style="color:#fff"><strong> Subject's Information</strong></caption>
        <tr>
