...
<body class="back" style="
background-image:url('assets/img/back1.jpg');
background-size:cover">
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">Timetable Management Redefined</h3>
        </div>
    </div>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/VIT.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/gate.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/annaaudi.jpg" alt="Flower">
        </div>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body" id="LoginType">
            ...
            <div style="display:none" id="adminForm">
                <form action="adminFormvalidation.php" method="POST" name="adminform" onsubmit="return validateForm()">
...
<script>
  ...
  var name = document.forms["adminform"]["UN"].value;
    ...
    <div class="container set-pad">
        <div class="row text-center">
            <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                <h1 data-scroll-reveal="enter from the bottom after 0.1s" class="header-line">Developers Of TMR</h1>
        ...
        <div class="row">
            ...
            <div class="col-lg-6  col-md-6 col-sm-6" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/me.jpeg" class="img-rounded"/>
                    <h3 align="center">Pranav Kapoor</h3>
                    <hr/>
                    <h4 align="center">Sr.<br/>Software Developer</h4>

                </div>
            </div>
            <div class="col-lg-6  col-md-6 col-sm-6" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/aishika.jpg" class="img-rounded"/>
                    <h3 align="center">Aishika Saha</h3>
                    <hr/>
                    <h4 align="center">Sr.<br/>Graphic Deigner</h4>
...
<div class="container">
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <h2 style="color:#fff"><strong>Our Location </strong></h2>
            <hr/>
            <div>
                <h4 style="color:#fff">Vit Vellore,
                </h4>
                <h4 style="color:#fff">Vellore,Tamil Nadu</h4>
                <h4 style="color:#fff"><strong>Call:</strong> 9999999999</h4>
                <h4 style="color:#fff"><strong>Email: </strong>tmr@tmr.com</h4>
            </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1"
            ...
            <h2 style="color:#fff"><strong>Social Conectivity </strong></h2>
            <hr/>
            <div>
